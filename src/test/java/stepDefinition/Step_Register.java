...
public class Step_Register {
	...
	List<HashMap<String,String>> dataSet = Getdata_excel.readExcelDatafromFile("C:\\Workspace\\first-project\\Ds-algo_Cucumber\\Excel_file\\OpenOffice 4.1.13.lnk", "Login");
	...
	public void enter_username_password_and_confirm_password(Integer int1) {
